...
class TestCache(unittest.TestCase):
    ...
    def test_retry_on_connection_error(self):
        ...
        self.assertEqual(redis_storage.db.get.call_count, Storage.MAX_RETRIES)
        self.assertEqual(redis_storage.db.set.call_count, Storage.MAX_RETRIES)
